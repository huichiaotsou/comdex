...
++https://github.com/comdex-official/comdex/blob/main/proto/comdex/liquidity/v1beta1/query.proto 
...
<!-- markdown-link-check-disable -->
```bash
http://localhost:1317/comdex/liquidity/v1beta1/params
```
...
<!-- markdown-link-check-disable -->
```bash
http://localhost:1317/comdex/liquidity/v1beta1/pairs
http://localhost:1317/comdex/liquidity/v1beta1/pairs?denoms=uatom
http://localhost:1317/comdex/liquidity/v1beta1/pairs?denoms=uatom&denoms=uusd
```
...
<!-- markdown-link-check-disable -->
```bash
http://localhost:1317/comdex/liquidity/v1beta1/pairs/1
```
...
<!-- markdown-link-check-disable -->
```bash
http://localhost:1317/comdex/liquidity/v1beta1/pools
http://localhost:1317/comdex/liquidity/v1beta1/pools?pair_id=1
http://localhost:1317/comdex/liquidity/v1beta1/pools?disabled=false
```
...
<!-- markdown-link-check-disable -->
```bash
http://localhost:1317/comdex/liquidity/v1beta1/pools/1
```
...
<!-- markdown-link-check-disable -->
```bash
http://localhost:1317/comdex/liquidity/v1beta1/pools/reserve_address/cre1353ausz7n8arsyf6dp0mq7gvj4ry2c2ht284kzrrft2mx7rdvfnsxuuamx
```
...
<!-- markdown-link-check-disable -->
```bash
http://localhost:1317/comdex/liquidity/v1beta1/pools/pool_coin_denom/pool1
```
...
<!-- markdown-link-check-disable -->
```bash
http://localhost:1317/comdex/liquidity/v1beta1/pools/1/deposit_requests
```
...
<!-- markdown-link-check-disable -->
```bash
http://localhost:1317/comdex/liquidity/v1beta1/pools/1/deposit_requests/1
```
...
<!-- markdown-link-check-disable -->
```bash
http://localhost:1317/comdex/liquidity/v1beta1/pools/1/withdraw_requests
```
...
<!-- markdown-link-check-disable -->
```bash
http://localhost:1317/comdex/liquidity/v1beta1/pools/1/withdraw_requests/1
```
...
<!-- markdown-link-check-disable -->
```bash
http://localhost:1317/comdex/liquidity/v1beta1/pairs/1/orders
```
...
<!-- markdown-link-check-disable -->
```bash
http://localhost:1317/comdex/liquidity/v1beta1/pairs/1/orders/1
```
...
<!-- markdown-link-check-disable -->
```bash
http://localhost:1317/comdex/liquidity/v1beta1/orders/cre1zaavvzxez0elundtn32qnk9lkm8kmcszxclz6p
```
