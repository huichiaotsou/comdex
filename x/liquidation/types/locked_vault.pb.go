...
type LockedVault struct {
	...
	Admin         string                                 `protobuf:"bytes,2,opt,name=admin,proto3" json:"admin,omitempty" yaml:"owner"`
	Debt          github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,3,opt,name=debt,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"debt" yaml:"debt"`
}
...
var fileDescriptor_6e1145b6fa4b74d3 = []byte{
	...
	,
	...
	0xc9, 0x73, 0x43, 0x0c, 0x05, 0x99, 0xa1, 0x14, 0x04, 0x36, 0xca, 0x29, 0xfc, 0xc4, 0x43, 0x39,
	...
	0x14, 0xc5, 0x78, 0x50, 0x90, 0xe9, 0xe6, 0xa7, 0xa5, 0x65, 0x26, 0x67, 0x26, 0xe6, 0x40, 0xf9,
	0xfa, 0xa8, 0x61, 0x0e, 0xb6, 0x31, 0x89, 0x0d, 0x1c, 0x66, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff,
	0xff, 0xd7, 0x61, 0x79, 0xaf, 0x96, 0x01, 0x00, 0x00,
}
...
func (m *LockedVault) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Admin) > 0 {
		i -= len(m.Admin)
		copy(dAtA[i:], m.Admin)
		i = encodeVarintLockedVault(dAtA, i, uint64(len(m.Admin)))
		i--
		dAtA[i] = 0x12
	}
