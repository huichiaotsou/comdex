...
The `MsgAdvanceEpoch` message is for testing purposes only and requires that you build the `comdex` binary. See [MsgAdvanceEpoch](04_messages.md#MsgAdvanceEpoch).
