...
import (
	...
	"github.com/comdex-official/comdex/x/farming/client/cli"
	"github.com/comdex-official/comdex/x/farming/expected"
	"github.com/comdex-official/comdex/x/farming/keeper"
...
func NewAppModule(
	cdc codec.Codec, keeper keeper.Keeper, accountKeeper expected.AccountKeeper,
	bankKeeper expected.BankKeeper,
) AppModule {
	return AppModule{
