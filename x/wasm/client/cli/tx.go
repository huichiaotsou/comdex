...
import (
	...
	feeutils "github.com/comdex-official/comdex/custom/auth/client/utils"
	wasmUtils "github.com/comdex-official/comdex/x/wasm/client/utils"
...
$ comdexd tx store ./path-to-binary 

Or to migrate columbus-4 code to columbus-5 code
$ comdexd tx store ./path-to-binary --migrate-code-id 3
`,
...
$ comdexd instantiate 1 '{"arbiter": "comdex~~"}'

You can also instantiate it with funds

$ comdexd instantiate 1 '{"arbiter": "comdex~~"}' "1000000uluna"
`,
...
$ comdexd tx wasm migrate comdex... 10 '{"verifier": "comdex..."}'
		`),
...
$ comdexd tx wasm update-admin comdex... comdex...
		`),
...
$ comdexd tx wasm clear-admin comdex... 
		`),
		Args: cobra.ExactArgs(2),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientTxContext(cmd)
